...
The error occurred when setting the required CT application subfolders ACL (setfacl) permissions. We recommend the User reads our Github NAS guides ( 'https://github.com/aquacate/nas-hardmetal' and 'https://github.com/aquacate/pve-nas' ) and makes sure the following constraints are satisfied:
...
The error occurred when creating subfolder file '.foo_protect' for chattr. We recommend the User reads our Github NAS guides ( 'https://github.com/aquacate/nas-hardmetal' and 'https://github.com/aquacate/pve-nas' ) and makes sure the following constraints are satisfied:
