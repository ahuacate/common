...
#---- Source Github
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/aquacate/common/forkpaths/pve/tool/pve_tester_ct_ubuntu.sh)"

#---- Source local Git
# /mnt/pve/nas-01-git/aquacate/common/pve/tool/pve_tester_ct_ubuntu.sh
