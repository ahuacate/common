...
k=2
if [[ "$NAS_IP" == *10.0.1.* || "$NAS_IP" == *192.168.1.* ]] && [[ ! "$NAS_IP" =~ ^[0-9]+\.[0-9]+\.[0-9]+\.(101|102|103|104|105)$ ]]
then
  ...
  echo
elif [[ "$NAS_IP" == *10.0.1.* || "$NAS_IP" == *192.168.1.* ]] && [[ "$NAS_IP" =~ ^[0-9]+\.[0-9]+\.[0-9]+\.(101|102|103|104|105)$ ]]
then
...
elif [[ ! "$NAS_IP" == *10.0.0.* || ! "$NAS_IP" == *192.168.1.* ]] && [[ ! "$NAS_IP" =~ ^[0-9]+\.[0-9]+\.[0-9]+\.(101|102|103|104|105)$ ]]
then
