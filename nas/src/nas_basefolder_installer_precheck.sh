#!/usr/bin/env bash
# ----------------------------------------------------------------------------------
# Filename:     nas_basefolder_installer_precheck.sh
# Description:  Source script for installers to check NAS base and sub folders
# ----------------------------------------------------------------------------------
...
pvesm_input_LIST=( "nas-01-video,/mnt/video" "nas-01-public,/mnt/public" )
...
if [ "${#pvesm_check_LIST[@]}" == '0' ]; then
  msg "Checking NAS sub-folders ..."
